    ...
    <h1>Formulário de cadastro loja virtual</h1>
        ...
        <form action="/cadastro.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="telefone" name="telefone" class="form-control" placeholder="Digite o seu telefone celular (XXXXX-XXXX)">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="cep" name="cep" class="form-control" placeholder="Digite o seu CEP(XXXXX-XXX)">
            </div>
